...
public class MassagePanel : BasePanel
{
    Text Text;
    //Text Text2;
    //float time=3f;
    ...
    {
        Text.text= SceneResMgr.Instance.GetClass().poop;
    ...
    public override void ShowMe()
    {
        ...
        rectTransform.DOAnchorPos(originalPosition, 0.5f)
                     ...
                     {
                         canvasGroup.blocksRaycasts = true;//回调
                     }); // 可选弹性缓动
    }
    ...
    protected override void OnClickButton(string UIname)
    {
        ...
        //print("01293810293810");
        UIMgr.Instance.ShowOneUI<GamePanel>();
        HideMe();
    }
}
